...
class WdioTestRailCucumberReporter extends events.EventEmitter {
    ...
    constructor(baseReporter, config) {
        ...
        this.on('test:pass', (test) => {
            ...
            let caseIds = titleToCaseIds(test.parent); //look in th parent for thwetest rail id (represents a scenario or scenario outline)
            if (caseIds.length > 0) {
...
WdioTestRailCucumberReporter.reporterName = 'WebDriver.io test rail reporter';
